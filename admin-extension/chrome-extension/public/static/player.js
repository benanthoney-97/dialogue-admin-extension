const TEMPLATE_HTML = `
  ...
  <div id="dialogue-nano-player">
    ...
    <div class="d-meta">
      <div class="d-meta-text-container">
        <span class="d-meta-text">Preview</span>
        <span class="d-meta-timestamp" id="dialogue-meta-timestamp">0:00</span>
      </div>
      <button class="d-meta-button" id="dialogue-create-match" disabled>
        Create match at 0:00
      </button>
